                    ...
                    <div class="col">
                        <form class="" action="" enctype="multipart/form-data" method="POST">
                            <div class="mb-3">
                                ...
                                <input type="text" disabled class="form-control" name="namamobil" id="namamobil" value="<?php echo $namamobil ?>">
                            </div>

                            <div class="mb-3">
                                <label for="nameinput" class="form-label">Nama Pemilik</label>
                                <input type="text" disabled class="form-control" name="namapemilik" id="namapemilik" value="<?php echo $namapemilik ?>">
                            </div>

                            <div class="mb-3">
                                <label for="nameinput" class="form-label">Merk</label>
                                <input type="text" disabled class="form-control" name="merk" id="merk" value="<?php echo $merk ?>">
                            </div>

                            <div class="mb-3 ">
                                <label for="dateinput" class="form-label">Tanggal Beli</label>
                                <input type="date" disabled class="form-control" name="tanggalbeli" id="tanggalbeli" value="<?php echo $tanggalbeli ?>">
                            </div>

                            <div class="mb-3 ">
                                <label for="phone" class="form-label">Deskripsi</label>
                                <input type="text" disabled class="form-control" name="deskripsi" id="deskripsi" value="<?php echo $deskripsi ?>">
                            </div>
                            ...
                            <div class="mb-3 ">
                                ...
                                <input type="text" disabled class="form-control" name="fotomobil" id="fotomobil" value="<?php echo $fotomobil ?>">
                            </div>
